...
function ResultGroup({ activeIndex, kind, offset, onActivate, results, title }) {
  return (
...
export function SearchDialog({ navigate }) {
  ...
  const [status, setStatus] = useState({ kind: "idle", message: "", detail: "" })
