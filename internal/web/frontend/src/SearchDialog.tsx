...
function isSearchDocument(value: unknown): value is SearchDocumentsResponse["documents"][number] {
...
function isSearchDocumentsResponse(value: unknown): value is SearchDocumentsResponse {
  return isRecord(value)
